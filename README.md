...
[![Go Report Card](https://goreportcard.com/badge/github.com/colo6299/makesite)](https://goreportcard.com/report/github.com/colo6299/makesite)
...
- [x] When your program finishes, print: `Success! Generated 5 pages.` The `Success!` substring must be <span style="color: green; font-weight:bold;">bold green</span>, and the count (`5`) must be **bold**. (I'm working on windows dammit!)
